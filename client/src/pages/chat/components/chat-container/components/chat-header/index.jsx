...
const ChatHeader = () => {
  const selectedChatData = useSelector(
    (state) => state.chat.selectedChatData
  );
  const selectedChatType = useSelector(
    (state) => state.chat.selectedChatType
  )
  ...
  return (
    <div className="h-[10vh] border-b-2 border-[#2f303b] flex items-center justfy-between px-20">
