...
import { useLoginMutation, useSignupMutation } from "../../services/authApi.js";
...
const Auth = () => {
    ...
    if (validateLogin()) {
      try {
        ...
        if (response.user.id) {
          ...
          if (response.user.profileSetup) navigate("/chat");
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex items-center justify-center">
      <div className="h-[88vh] bg-white border-2 border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] xl-[60vw] rounded-3xl grid xl:grid-cols-2">
